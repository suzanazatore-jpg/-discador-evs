const DEFAULT_BASE_GERAL_ENDPOINT =
  'https://script.google.com/macros/s/AKfycbztC2sN5wCYBxFivzOy37_PYoXDnEFp2F06CvWEg_CWoI0j9ny2_zDt60dEsXHKslD8kw/exec';

function getEndpoint() {
  return process.env.BASE_GERAL_APPS_SCRIPT_URL || DEFAULT_BASE_GERAL_ENDPOINT;
}
...
export function baseGeralMustBeAvailable() {
  return process.env.BASE_GERAL_REQUIRED !== 'false';
}
